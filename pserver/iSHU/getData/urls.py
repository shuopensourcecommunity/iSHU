...
urlpatterns = [
    ...
    url(r'^index/(?P<section>getjwcmessagebyid)$',get_msg_list,name = 'getjwcmessagebyid'),
    url(r'^index/(?P<section>getxgbmessagebyid)$',get_msg_list,name = 'getxgbmessagebyid'),
]
